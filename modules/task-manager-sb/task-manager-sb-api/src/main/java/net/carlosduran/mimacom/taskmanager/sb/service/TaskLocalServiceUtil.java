 ...
 * <code>net.carlosduran.mimacom.taskmanager.sb.service.impl.TaskLocalServiceImpl</code> and
...
public class TaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>net.carlosduran.mimacom.taskmanager.sb.service.impl.TaskLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Task> getFinishedTasks(long userId) {
		return getService().getFinishedTasks(userId);
	}
	...
	public static List<Task> getPendingTasks(long userId) {
		return getService().getPendingTasks(userId);
	}
