...
package net.carlosduran.mimacom.taskmanager.sb.service.persistence;
...
/**
 * The persistence utility for the task service. This utility wraps <code>net.carlosduran.mimacom.taskmanager.sb.service.persistence.impl.TaskPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TaskUtil {
	...
	public static Task findByUuid_First(
		...
		throws net.carlosduran.mimacom.taskmanager.sb.exception.
			NoSuchTaskException {
	 ...
	 * @return the matching tasks
	 */
	public static List<Task> findByuserIdAndStatus(long userId, int status) {
	 ...
	 * @return the range of matching tasks
	 */
	public static List<Task> findByuserIdAndStatus(
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByuserIdAndStatus_First(
	 ...
	 * @return the first matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByuserIdAndStatus_First(
		long userId, int status, OrderByComparator<Task> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByuserIdAndStatus_Last(
			long userId, int status, OrderByComparator<Task> orderByComparator)
		throws net.carlosduran.mimacom.taskmanager.sb.exception.
			NoSuchTaskException {
	 ...
	 * @return the last matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByuserIdAndStatus_Last(
		long userId, int status, OrderByComparator<Task> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a task with the primary key could not be found
	 */
	public static Task[] findByuserIdAndStatus_PrevAndNext(
		...
		return getPersistence().findByuserIdAndStatus_PrevAndNext(
			taskId, userId, status, orderByComparator);
	}
